      ...
      <div class="container">
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <?php
              $run_cources_lessons_q = mysqli_query($con, "SELECT * FROM `payments` where 1");
              while ($run_cources_lessons = mysqli_fetch_assoc($run_cources_lessons_q)) {
                ...
                <tr class="">
                  ...
                  <td>
                    <?php
                   $feedback_u_id = $run_cources_lessons['material_id'];
                   $select_user = "SELECT * FROM `materials` WHERE `id`=$feedback_u_id";
                   $run_user = mysqli_query($con, $select_user);
                   while ($row_user = mysqli_fetch_array($run_user)) {
